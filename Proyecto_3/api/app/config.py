...
REGISTERED_MODEL_NAME = os.environ.get("REGISTERED_MODEL_NAME", "real-estate-price-model")
...
POSTGRES_DB       = os.environ.get("POSTGRES_DATASET_DATABASE", "real_estate_data")
